...
<head>
    @notifyCss
    <meta charset="utf-8" />
    <title>@yield('title', 'Servinext')</title>
                            ...
                            <div class="collapse menu-dropdown" id="sidebarCuentas">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    @can('viewAny', App\Models\Account::class)
                                        <li class="nav-item">
                                            <a href="{{ route('accounts.index') }}" class="nav-link" data-key="t-clientes">Cuentas streaming</a>
                                        </li>
                                    @endcan
                                    {{-- @if(auth()->user()->hasRole('Super Admin') || auth()->user()->hasRole('Admin'))
                                        <li class="nav-item">
